...
<div class="max-w-2xl space-y-4">
  ...
  <div>
    ...
    <textarea id="sceneText" class="w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 p-3" rows="8" bind:value={sceneText}></textarea>
  </div>
