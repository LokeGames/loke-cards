...
import "clsx";
import { p as pending, s as status, l as lastSync, e as error, N as NetworkToggle, T as ThemeToggle } from "../../chunks/ThemeToggle.js";
...
function AppHeader($$renderer, $$props) {
  ...
  $$renderer.push(`<header class="flex items-center justify-between gap-3 px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900"><button class="md:hidden p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="Toggle menu"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6"><path fill-rule="evenodd" d="M3.75 5.25a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 0 1.5h-15a.75.75 0 0 1-.75-.75Zm0 6.75a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 0 1.5h-15a.75.75 0 0 1-.75-.75Zm0 6.75a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 0 1.5h-15a.75.75 0 0 1-.75-.75Z" clip-rule="evenodd"></path></svg></button> <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-100">${escape_html(title)}</h1> <div class="ml-auto flex items-center gap-2">`);
  StatusPill($$renderer, {});
  $$renderer.push(`<!----> `);
...
function NavLink($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<a${attr("href", to)}${attr_class(clsx(className))}><!--[-->`);
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<div class="min-h-screen flex bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">`);
    AppSidebar($$renderer2);
    $$renderer2.push(`<!----> <div class="flex-1 flex flex-col min-w-0">`);
    AppHeader($$renderer2, { title: "Loke Cards (Svelte)" });
    $$renderer2.push(`<!----> <main class="p-4"><!--[-->`);
    slot($$renderer2, $$props, "default", {});
