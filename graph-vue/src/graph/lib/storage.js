...
export const sceneStore = localforage.createInstance({ name: 'loke-graph', storeName: 'scenes' });
export const chapterStore = localforage.createInstance({ name: 'loke-graph', storeName: 'chapters' });
