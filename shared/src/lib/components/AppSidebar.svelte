...
<aside class="hidden md:flex md:flex-col md:w-60 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
  <nav class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-300">
    <a class="block px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800" href="/">Home</a>
    <a class="block px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800" href="/nodes">Nodes</a>
  </nav>
...
{#if open}
  ...
  <aside class="md:hidden fixed z-50 inset-y-0 left-0 w-72 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 p-3">
    ...
    <nav class="space-y-1 text-sm text-gray-700 dark:text-gray-300">
      <a class="block px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800" href="/">Home</a>
      <a class="block px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800" href="/nodes">Nodes</a>
    </nav>
  </aside>
