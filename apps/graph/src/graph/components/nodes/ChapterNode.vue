  ...
  >
    <div class="chapter-header px-4 py-3 border-b border-purple-200 dark:border-purple-800 rounded-t-xl bg-purple-100 dark:bg-purple-900/30">
      <div class="flex items-center gap-2">
        ...
        <h3 class="font-bold text-lg text-purple-800 dark:text-purple-200">{{ data.title }}</h3>
      </div>
    </div>
    <div class="chapter-content p-4">
      <div class="text-sm text-gray-500 dark:text-gray-400 italic">Scenes in this chapter will appear here</div>
    </div>
  </div>
</template>

<script setup>
defineProps({ id: String, data: { type: Object, required: true }, selected: { type: Boolean, default: false } })
</script>

<style scoped>
.chapter-node { cursor: pointer; }
</style>
